            ...
            <table class="table table-hover table-bordered table-striped mb-0" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="my-btn">
                            {{-- edit button --}}
                            <a class="btn btn-success btn-sm text-white" href="{{route('district.edit', $district->id)}}"><i class="fa-solid fa-pen-to-square text-white"></i>Edit</a>
                            {{-- delete button with modal --}}
                            <a class="btn btn-danger btn-sm text-white" href="#" data-toggle="modal" data-target="#deletedistrict{{$district->id}}"><i class="fa fa-solid fa-trash"></i>Delete</a>
                    ...
                    <div class="modal fade" id="deletedistrict{{$district->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content text-left">
                            ...
                            <ul>
                            <li><a href="{{route('district.destroy', $district->id)}}" class="btn btn-danger text-white">Delete</a></li>
